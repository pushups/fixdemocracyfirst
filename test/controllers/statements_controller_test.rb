...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { approved: @statement.approved, campaign_id: @statement.campaign_id, candidate_id: @statement.candidate_id, description: @statement.description, event_day_id: @statement.event_day_id, rwu_id: @statement.rwu_id, title: @statement.title, ugc_candidate_name: @statement.ugc_candidate_name, ugc_date: @statement.ugc_date.strftime('%m/%d/%Y'), ugc_event_location: @statement.ugc_event_location, ugc_event_title: @statement.ugc_event_title, ugc_notes: @statement.ugc_notes, url: @statement.url, user_id: @statement.user_id }
    end
